		...
		>
			<div className="relative flex items-center justify-center">
				...
				<Link
					...
					className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 transition-transform duration-300 hover:-translate-y-1 hover:scale-110 active:scale-95 sm:h-16 sm:w-16"
				...
				>
					<svg
						...
						viewBox="0 0 24 24"
						fill="currentColor"
						className="transition-transform duration-300 group-hover:scale-110 sm:h-9 sm:w-9"
					>
